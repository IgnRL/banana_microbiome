...
orgmatter_plot_interac <- soilt0t4%>% ggplot(aes(x=treatment, group= time, col= time, y= org.matter))+ geom_point()+
  labs(title = "ORGANIC MATTER T4 preguntar ignacio", subtitle = "HSDTukey" , caption = "p-value" )
orgmatter_plot_interac
...
phospho_plot_interac <- soilt0t4%>% ggplot(aes(x=treatment, group= time, col= time, y= phosphorus))+ geom_point()+
  labs(title = "PHOSPHORUS", subtitle = "HSDTukey" , caption = "p-value" )
phospho_plot_interac
```
