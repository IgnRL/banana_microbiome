...
leveneTest(org.matter~ treatment, data=soilt0t4) # no equal variances 

anova_orgt0t4 <- aov(org.matter ~ time + treatment, data=soilt0t4) #anova two ways
summary(anova_orgt0t4)
#Para controlar el efecto de las diferencias entre repeticiones, añadimos un tercer término, "block"
anova_orgt0t4int <- aov(org.matter ~ time * treatment, data=soilt0t4) # interaction between them?
