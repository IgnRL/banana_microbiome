...
soilparameters1 <- ggarrange(org.mat.plotsd+ theme(legend.position="none"), 
                            sodium.plotsd+ theme(legend.position="none"), 
                            calcium.plotsd + theme(legend.position="none"),
                            potassium.plotsd+ theme(legend.position="bottom"),
                            phosp.plotsd + theme(legend.position="none"),
                             ncol=2)
soilparameters1
...
soilt4$log_conductivity <- log10(soilt4$conductivity)
shapiro.test(soilt4$log_conductivity)
soilt4 %>% group_by(treatment) %>% shapiro_test(log_conductivity)
soil_prop$log_conductivity <- log10(soil_prop$conductivity)
shapiro.test(soil_prop$conductivity)
soil_prop %>% group_by(treatment) %>% shapiro_test(log_conductivity)
