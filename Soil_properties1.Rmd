...
## Comprobamos la correlacion entre las variables para analizar las mas interesantes
...
shapiro.test(soilt0$phosphorus)#ahora vamos a comprobar la normalidad de los datos. Los datos no son normales. 
soilt0 %>% group_by(treatment) %>% shapiro_test(phosphorus) #aqui comprobamos la normalidad de los datos de phosphorus en cada tratamiento. Todos son normales.OJO aqui si hay un valor que se va
...
soilt0 %>% group_by(treatment) %>% shapiro_test(ph.water) #aqui comprobamos la normalidad de los datos de ph_water en cada tratamiento. Todos son normales.
...
plot_phwater_t0 <- soilt0 %>% ggplot(aes(x= treatment, y= ph.water))+
  ...
  labs(title = "Figure 2: Differences in ph water at T0.", subtitle = "HSDTukey" , caption = "p-value" )
plot_phwater_t0
```

```{r conductivity stats, echo=FALSE}
shapiro.test(soilt0$conductivity)
soil_prop %>% group_by(treatment) %>% shapiro_test(conductivity) #aqui comprobamos la normalidad de los datos de ph_water en cada tratamiento. Todos son normales. OJO pero hay un dato que se va
...
plot_conduc_t0 <- soilt0 %>% ggplot(aes(x= treatment, y= conductivity))+
  ...
  labs(title = "Figure 2: Differences in conductivity at T0.", subtitle = "HSDTukey" , caption = "p-value, ojo un dato se va" )
plot_conduc_t0
```
...
plot_calcium_t0 <- soilt0 %>% ggplot(aes(x= treatment, y= calcium))+
  ...
  labs(title = "Figure 2: Differences in calcium at T0.", subtitle = "HSDTukey" , caption = "p-value" )
plot_calcium_t0
...
plot_sodium_t0 <- soilt0 %>% ggplot(aes(x= treatment, y= sodium))+
  ...
  labs(title = "Figure 2: No Differences in sodium at T0.", subtitle = "HSDTukey" , caption = "p-value" )
plot_sodium_t0
```
...
plot_potassium_t0 <- soilt0 %>% ggplot(aes(x= treatment, y= potassium))+
  ...
  labs(title = "Figure 2: Differences in potassium at T0.", subtitle = "HSDTukey" , caption = "p-value" )
plot_potassium_t0
```


```{r stats nitrogen, echo=FALSE}
shapiro.test(soilt0$nitrogen)
soil_prop %>% group_by(treatment) %>% shapiro_test(nitrogen)
...
plot_nitrogen_t0 <- soilt0 %>% ggplot(aes(x= treatment, y= nitrogen))+
  ...
  labs(title = "Figure 2: Differences in nitrogen at T0.", subtitle = "HSDTukey" , caption = "p-value" )
plot_nitrogen_t0
...
plot_phosphorus_t4 <- soilt4 %>% ggplot(aes(x= treatment, y= phosphorus))+
  ...
  labs(title = "Figure 1: Differences in phosphorus at T4.", subtitle = "HSDTukey" , caption = "p-value" )
plot_phosphorus_t4
```
...
plot_ph.water_t4 <- soilt4 %>% ggplot(aes(x= treatment, y= phosphorus))+
  geom_point()+
  stat_summary(fun=mean, aes(x= treatment, y = ph.water),
  ...
  labs(title = "Figure 1: Differences in ph.water at T4.", subtitle = "HSDTukey" , caption = "p-value" )
plot_ph.water_t4
