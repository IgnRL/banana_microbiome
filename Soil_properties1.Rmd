...
tukey_orgmattert0t4time #preguntar ignacio 
...
avg_orgt0t4
#plot de treatment
plot_orgmatter_t0t4 <- soilt0t4 %>% ggplot(aes(x= treatment, group= time, col=time, y= org.matter))+
  geom_point()+
  stat_summary(fun=mean, aes(x= treatment, y = org.matter),
               geom= "crossbar", colour= "violet", data=avg_orgt0t4, fatten=3)+
  geom_text(data=tukey_orgmattert0t4treat, aes(x=treatment, y = org.matter, label= groups), nudge_x= 0.2, nudge_y= 0.01)+
  labs(title = "Figure 1: Differences in org.matter between T0 and T4.", subtitle = "HSDTukey" , caption = "p-value" )
plot_orgmatter_t0t4
