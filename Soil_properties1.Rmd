...
ggsave(figure_title, file="soil_parameters_result/soilproperties_time.png", width= 1900,height= 1200, units= "px")

figureall2.2 <- grid.arrange(org.mat.plotsd, phosp.plotsd, pH_water.plotsd, potassium.plotsd)
figureall2.3 <- grid.arrange(sodium.plotsd,calcium.plotsd, nitrogen.plotsd, conductivity.plotsd)

ggsave(figureall2.2, file="soil_parameters_result/soilproperties_time2_2.png", width= 1900,height= 1200, units= "px")
ggsave(figureall2.3, file="soil_parameters_result/soilproperties_time2_3.png", width= 1900,height= 1200, units= "px")
```
...
ggsave(plot_nitrogen_t0, file="prueba/nitrogen_t0.png", width= 1900,height= 1200, units= "px")
