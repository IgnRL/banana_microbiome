...
anova_basalt0t4int <- aov(mg_co_basal ~ time * treatment +rep , data=respirationt0t4) # interaction between them?
anova_basalt0t4int
basalt0t4lm <- lm(mg_co_basal~ time*treatment +rep, data=respirationt0t4)#model
anova(basalt0t4lm)
