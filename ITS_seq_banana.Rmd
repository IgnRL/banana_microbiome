...
save(emmeans.shannon, file= "ITS_results/emmeans_treat_shannon.RDa")
emmeans.shannon <- load(file="ITS_results/emmeans_treat_shannon.RDa")

emmeans.shannon.time <- cld(emmeans(lmer.shannon,~time), Letters = letters, reversed= TRUE)
save(emmeans.shannon.treatment, file= "ITS_results/emmeans_time_shannon.RDa")
emmeans.shannon.treatment <- load(file="ITS_results/emmeans_time_shannonshannon.RDa")
...
save(emmeans.richness.treatment, file= "ITS_results/emmeans_treat_richness.RDa")
emmeans.richness.treatment <- load(file="ITS_results/emmeans_treat_richness.RDa")
emmeans.richness.time <- cld(emmeans(lmer.richness,~time), Letters = letters, reversed= TRUE)
save(emmeans.richness.time, file= "ITS_results/emmeans_time_richness.RDa")
emmeans.richness.time <- load(file="ITS_results/emmeans_time_richness.RDa")
...
save(emmeans.evenness.treatment, file= "ITS_results/emmeans_treat_evenness.RDa")
emmeans.evenness.treatment <- load(file="ITS_results/emmeans_treat_evenness.RDa")
emmeans.evenness.time <- cld(emmeans(lmer.evenness,~time), Letters = letters, reversed= TRUE)
save(emmeans.evenness.time, file= "ITS_results/emmeans_time_evenness.RDa")
emmeans.evenness.time <- load(file="ITS_results/emmeans_time_evenness.RDa")
```
