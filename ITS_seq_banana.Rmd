...
emmeans.shannon <- cld(emmeans(lmer.shannon, ~ treatment), Letters = letters, reversed= TRUE)
save(emmeans.shannon, file= "ITS_results/emmeans.shannon.RDa")
...
whinnie <- data.frame(
  Speaker = c("Pooh", "Pooh", "Pooh", "Pooh", "Pooh", "Pooh", "Pooh", "Pooh", "Pooh", "Pooh", "Piglet", "Piglet", "Piglet", "Piglet", "Piglet", "Piglet", "Piglet", "Piglet", "Piglet", "Piglet","Tigger", "Tigger", "Tigger", "Tigger", "Tigger", "Tigger", "Tigger", "Tigger", "Tigger", "Tigger"),
  Likert = c(3, 5, 4, 4, 4, 4, 4, 4, 5, 5, 2, 4, 2, 2, 1, 2, 3, 2, 2, 3,4, 4, 4, 4, 5, 3, 5, 4, 4, 3))



whinnie$Speaker = factor(whinnie$Speaker,
                      levels=unique(whinnie$Speaker))
whinnie$Likert.f = factor(whinnie$Likert,
                       ordered = TRUE)
str(whinnie)
summary(whinnie)
