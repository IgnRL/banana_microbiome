...
ggsave(shannon.plots, file="ITS_results/shannon_treat_facet.png", width=4000, height= 4000, units = "px")
```
...
ggsave(evenness.plots, file="ITS_results/evenness_treat_facet.png", width=4000, height= 4000, units = "px")
```
...
ggsave(richness.plots, file="ITS_results/richness_treat_facet.png", width=4000, height= 4000, units = "px")
```
