...
shannon_treat_facet <- data %>% ggplot(aes(x= treatment, y= shannon, color= time)) +
  geom_point()+
  scale_color_manual(values= time.colors)+
  facet_wrap(~time)+
  theme_classic2()+
...
shannon_time_facet <- data %>% ggplot(aes(x= factor(time), y= shannon, color= treatment, group = 1)) +
  geom_point()+
  scale_color_manual(values= treat.colors)+
...
evenness_time_facet <- data %>% ggplot(aes(x= factor(time), y= evenness, color= treatment, group = 1)) +
  geom_point()+
  scale_color_manual(values= treat.colors)+
  geom_smooth(aes(col= treatment), method = "lm", se = FALSE, size = 1) + 
  facet_wrap(~treatment)+
...
```{r richness, include=TRUE}
data <- sample_data(zotu97.rar)

data %>% ggplot(aes(x= treatment, y= richness, color= time)) +
  geom_point()+
  scale_color_manual(values= time.colors)+
  facet_wrap(~time)+
  theme_classic2()+
...
data %>% ggplot(aes(x= factor(time), y= richness, color= treatment, group = 1)) +
  geom_point()+
  scale_color_manual(values= treat.colors)+
  geom_smooth(aes(col= treatment), method = "lm", se = FALSE, size = 1) + 
  facet_wrap(~treatment)+
