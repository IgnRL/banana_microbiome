...
plotdeltaorgnew <- delta.mat.org %>% ggplot(aes(x=factor(treatment, level= treat.order), y= delta, fill= treatment))+
  ...
  labs(title = "", subtitle = "", caption = "Different (*) indicates differences between the delta T4-T0 variation.\n Cross bar meaning the mean of delta.", size = 10)+
  ggtitle("OM (%) Δ variation T0 between T4", subtitle= paste("LinealModel-Anova Treatment(Tukey) p-value: ", format(anova_deltaorgt0t4$`Pr(>F)`[[1]], scientific= TRUE, digits=2 ), sep= ""))+
  theme(
    plot.title = element_text(size = 11),
    plot.subtitle = element_text(size = 10),
...
plotdeltaorgnew
ggsave(plotdeltaorgnew, file="soil_parameters_result/plotdeltaorgnew.png", width= 1900,height= 1200, units= "px")
...
####delta nuevo######
delta.phospho
delta.phospho.lm0 <- lm(delta ~ 0+treatment, data=delta.phospho) #modelo normal 
delta.phospho.lm0

summary(delta.phospho.lm0) 
newanova_deltaphosphot0t4 <-anova(delta.phospho.lm)#3.973e-06 ***
newanova_deltaphosphot0t4
dp_val_phosphot0t4 <- summary(delta.phospho.lm0)$coefficient%>%
  as.data.frame()%>%
  rownames_to_column(var= "treatment")
dp_val_phosphot0t4
dp_val_phosphot0t4$treatment<-sub("treatment", "", dp_val_phosphot0t4$treatment)#add sig. que no sean lettras
dp_val_phosphot0t4$sign <- ifelse(dp_val_phosphot0t4$`Pr(>|t|)`<0.05, "*", "ns")
dp_val_phosphot0t4$sign <- ifelse(dp_val_phosphot0t4$`Pr(>|t|)`>0.05, paste("ns"),
                                 ifelse(dp_val_phosphot0t4$`Pr(>|t|)`>0.01, paste("*"),
                                        ifelse(dp_val_phosphot0t4$`Pr(>|t|)`> 0.001,
                                               paste("**"), paste("***"))))#para add la

dp_val_phosphot0t4
#dp_val_phosphot0t4$size <- ifelse(dp_val_phosphot0t4$sign== "*", 8, 4)
#dp_val_phosphot0t4$size <- as.numeric(dp_val_phosphot0t4$size)
dp_val_phosphot0t4


plotdeltaphosphonew <- delta.phospho %>% ggplot(aes(x=factor(treatment, level= treat.order), y= delta, fill= treatment))+
  geom_point(pch= 23, size= 7)+
  xlab("")+
  ylab("phosphorus variation between t4-t0")+
  geom_hline(yintercept= 0, linetype = "dashed", color = "red")+
  scale_fill_manual(values= treat.colors)+
  geom_text(data = dp_val_phosphot0t4, aes(x = treatment, y = Estimate, label = sign),
            position = position_dodge(width = 0.8), vjust = -0.5, size = 8)+
  guides(fill=guide_legend(title="Treatment"))+
  scale_x_discrete(labels= treat.labels)+
  theme_classic2()+
  stat_summary(fun=mean, aes(x= treatment, y = delta),geom= "crossbar", width=0.5, colour= "grey20", data=delta.phospho)+
  labs(title = "", subtitle = "", caption = "Different (*) indicates differences between the delta T4-T0 variation.\n Cross bar meaning the mean of delta.", size = 10)+
  ggtitle("phosphorus \u0394 variation T0 between T4", subtitle= paste("LinealModel-Anova Treatment(Tukey) p-value: ", format(newanova_deltaphosphot0t4$`Pr(>F)`[[1]], scientific= TRUE, digits=2 ), sep= ""))+
  theme(
    plot.title = element_text(size = 11),
    plot.subtitle = element_text(size = 10),
    plot.caption = element_text(size = 8))
...
plotdeltaphosphonew
ggsave(plotdeltaphosphonew, file="soil_parameters_result/plotdeltaphosphonew.png", width= 1900,height= 1200, units= "px")
...
########################delta new####################
delta.ph.water
delta.ph.water.lm0 <- lm(delta ~ 0+treatment, data=delta.ph.water) #modelo normal 
delta.ph.water.lm0

summary(delta.ph.water.lm0) 
newanova_deltaph.watert0t4 <-anova(delta.ph.water.lm0)#3.973e-06 ***
newanova_deltaph.watert0t4
dp_val_ph.watert0t4 <- summary(delta.ph.water.lm0)$coefficient%>%
  as.data.frame()%>%
  rownames_to_column(var= "treatment")
dp_val_ph.watert0t4
dp_val_ph.watert0t4$treatment<-sub("treatment", "", dp_val_ph.watert0t4$treatment)#add sig. que no sean lettras
dp_val_ph.watert0t4$sign <- ifelse(dp_val_ph.watert0t4$`Pr(>|t|)`<0.05, "*", "ns")
dp_val_ph.watert0t4$sign <- ifelse(dp_val_ph.watert0t4$`Pr(>|t|)`>0.05, paste("ns"),
                                 ifelse(dp_val_ph.watert0t4$`Pr(>|t|)`>0.01, paste("*"),
                                        ifelse(dp_val_ph.watert0t4$`Pr(>|t|)`> 0.001,
                                               paste("**"), paste("***"))))#para add la

dp_val_ph.watert0t4
#dp_val_ph.watert0t4$size <- ifelse(dp_val_ph.watert0t4$sign== "*", 8, 4)
#dp_val_ph.watert0t4$size <- as.numeric(dp_val_ph.watert0t4$size)
dp_val_ph.watert0t4


plotdeltaph.waternew <- delta.ph.water %>% ggplot(aes(x=factor(treatment, level= treat.order), y= delta, fill= treatment))+
  geom_point(pch= 23, size= 7)+
  xlab("")+
  ylab("ph.water \u0394")+
  geom_hline(yintercept= 0, linetype = "dashed", color = "red")+
  scale_fill_manual(values= treat.colors)+
  geom_text(data = dp_val_ph.watert0t4, aes(x = treatment, y = Estimate, label = sign),
            position = position_dodge(width = 0.8), vjust = -0.5, size = 8)+
  guides(fill=guide_legend(title="Treatment"))+
  scale_x_discrete(labels= treat.labels)+
  theme_classic2()+
  stat_summary(fun=mean, aes(x= treatment, y = delta),geom= "crossbar", width=0.5, colour= "grey20", data=delta.ph.water)+
  labs(title = "", subtitle = "", caption = "Different (*) indicates differences between the delta T4-T0 variation.\n Cross bar meaning the mean of delta.", size = 10)+
  ggtitle("ph.water \u0394 variation T0 between T4", subtitle= paste("LinealModel-Anova Treatment(Tukey) p-value: ", format(newanova_deltaph.watert0t4$`Pr(>F)`[[1]], scientific= TRUE, digits=2 ), sep= ""))+
  theme(
    plot.title = element_text(size = 11),
    plot.subtitle = element_text(size = 10),
    plot.caption = element_text(size = 8))

plotdeltaph.waternew
ggsave(plotdeltaph.waternew, file="soil_parameters_result/plotdeltaph_waternew.png", width= 1900,height= 1200, units= "px")
...
########################delta new####################
delta.conduc
delta.conduc.lm0 <- lm(delta ~ 0+treatment, data=delta.conduc) #modelo normal 
delta.conduc.lm0

summary(delta.conduc.lm0) 
newanova_deltaconduct0t4 <-anova(delta.conduc.lm0)#3.973e-06 ***
newanova_deltaconduct0t4
dp_val_conduct0t4 <- summary(delta.conduc.lm0)$coefficient%>%
  as.data.frame()%>%
  rownames_to_column(var= "treatment")
dp_val_conduct0t4
dp_val_conduct0t4$treatment<-sub("treatment", "", dp_val_conduct0t4$treatment)#add sig. que no sean lettras
dp_val_conduct0t4$sign <- ifelse(dp_val_conduct0t4$`Pr(>|t|)`<0.05, "*", "ns")
dp_val_conduct0t4$sign <- ifelse(dp_val_conduct0t4$`Pr(>|t|)`>0.05, paste("ns"),
                                 ifelse(dp_val_conduct0t4$`Pr(>|t|)`>0.01, paste("*"),
                                        ifelse(dp_val_conduct0t4$`Pr(>|t|)`> 0.001,
                                               paste("**"), paste("***"))))#para add la

dp_val_conduct0t4
#dp_val_conduct0t4$size <- ifelse(dp_val_conduct0t4$sign== "*", 8, 4)
#dp_val_conduct0t4$size <- as.numeric(dp_val_conduct0t4$size)
dp_val_conduct0t4


plotdeltaconducnew <- delta.conduc %>% ggplot(aes(x=factor(treatment, level= treat.order), y= delta, fill= treatment))+
  geom_point(pch= 23, size= 7)+
  xlab("")+
  ylab("conduc \u0394")+
  geom_hline(yintercept= 0, linetype = "dashed", color = "red")+
  scale_fill_manual(values= treat.colors)+
  geom_text(data = dp_val_conduct0t4, aes(x = treatment, y = Estimate, label = sign),
            position = position_dodge(width = 0.8), vjust = -0.5, size = 8)+
  guides(fill=guide_legend(title="Treatment"))+
  scale_x_discrete(labels= treat.labels)+
  theme_classic2()+
  stat_summary(fun=mean, aes(x= treatment, y = delta),geom= "crossbar", width=0.5, colour= "grey20", data=delta.conduc)+
  labs(title = "", subtitle = "", caption = "Different (*) indicates differences between the delta T4-T0 variation.\n Cross bar meaning the mean of delta.", size = 10)+
  ggtitle("conduc \u0394 variation T0 between T4", subtitle= paste("LinealModel-Anova Treatment(Tukey) p-value: ", format(newanova_deltaconduct0t4$`Pr(>F)`[[1]], scientific= TRUE, digits=2 ), sep= ""))+
  theme(
    plot.title = element_text(size = 11),
    plot.subtitle = element_text(size = 10),
    plot.caption = element_text(size = 8))
...
plotdeltaconducnew
ggsave(plotdeltaconducnew, file="soil_parameters_result/plotdeltaph_waternew.png", width= 1900,height= 1200, units= "px")
...
summary(delta.calcium.lm0) 
newanova_deltacalciumt0t4 <-anova(delta.calcium.lm0)#3.973e-06 ***
newanova_deltacalciumt0t4
dp_val_calciumt0t4 <- summary(delta.calcium.lm0)$coefficient%>%
  as.data.frame()%>%
  rownames_to_column(var= "treatment")
dp_val_calciumt0t4
dp_val_calciumt0t4$treatment<-sub("treatment", "", dp_val_calciumt0t4$treatment)#add sig. que no sean lettras
dp_val_calciumt0t4$sign <- ifelse(dp_val_calciumt0t4$`Pr(>|t|)`<0.05, "*", "ns")
dp_val_calciumt0t4$sign <- ifelse(dp_val_calciumt0t4$`Pr(>|t|)`>0.05, paste("ns"),
                                 ifelse(dp_val_calciumt0t4$`Pr(>|t|)`>0.01, paste("*"),
                                        ifelse(dp_val_calciumt0t4$`Pr(>|t|)`> 0.001,
                                               paste("**"), paste("***"))))#para add la

dp_val_calciumt0t4
#dp_val_calciumt0t4$size <- ifelse(dp_val_calciumt0t4$sign== "*", 8, 4)
#dp_val_calciumt0t4$size <- as.numeric(dp_val_calciumt0t4$size)
dp_val_calciumt0t4


plotdeltacalciumnew <- delta.calcium %>% ggplot(aes(x=factor(treatment, level= treat.order), y= delta, fill= treatment))+
  geom_point(pch= 23, size= 7)+
  xlab("")+
  ylab("calcium \u0394")+
  geom_hline(yintercept= 0, linetype = "dashed", color = "red")+
  scale_fill_manual(values= treat.colors)+
  geom_text(data = dp_val_calciumt0t4, aes(x = treatment, y = Estimate, label = sign),
            position = position_dodge(width = 0.8), vjust = -0.5, size = 8)+
  guides(fill=guide_legend(title="Treatment"))+
  scale_x_discrete(labels= treat.labels)+
  theme_classic2()+
  stat_summary(fun=mean, aes(x= treatment, y = delta),geom= "crossbar", width=0.5, colour= "grey20", data=delta.calcium)+
  labs(title = "", subtitle = "", caption = "Different (*) indicates differences between the delta T4-T0 variation.\n Cross bar meaning the mean of delta.", size = 10)+
  ggtitle("calcium \u0394 variation T0 between T4", subtitle= paste("LinealModel-Anova Treatment(Tukey) p-value: ", format(newanova_deltacalciumt0t4$`Pr(>F)`[[1]], scientific= TRUE, digits=2 ), sep= ""))+
  theme(
    plot.title = element_text(size = 11),
    plot.subtitle = element_text(size = 10),
    plot.caption = element_text(size = 8))
...
plotdeltacalciumnew
ggsave(plotdeltacalciumnew, file="soil_parameters_result/plotdeltacalciumnew.png", width= 1900,height= 1200, units= "px")
...
########################delta new####################
delta.sodium
delta.sodium.lm0 <- lm(delta ~ 0+treatment, data=delta.sodium) #modelo normal 
delta.sodium.lm0

summary(delta.sodium.lm0) 
newanova_deltasodiumt0t4 <-anova(delta.sodium.lm0)#3.973e-06 ***
newanova_deltasodiumt0t4
dp_val_sodiumt0t4 <- summary(delta.sodium.lm0)$coefficient%>%
  as.data.frame()%>%
  rownames_to_column(var= "treatment")
dp_val_sodiumt0t4
dp_val_sodiumt0t4$treatment<-sub("treatment", "", dp_val_sodiumt0t4$treatment)#add sig. que no sean lettras
dp_val_sodiumt0t4$sign <- ifelse(dp_val_sodiumt0t4$`Pr(>|t|)`<0.05, "*", "ns")
dp_val_sodiumt0t4$sign <- ifelse(dp_val_sodiumt0t4$`Pr(>|t|)`>0.05, paste("ns"),
                                 ifelse(dp_val_sodiumt0t4$`Pr(>|t|)`>0.01, paste("*"),
                                        ifelse(dp_val_sodiumt0t4$`Pr(>|t|)`> 0.001,
                                               paste("**"), paste("***"))))#para add la

dp_val_sodiumt0t4
#dp_val_sodiumt0t4$size <- ifelse(dp_val_sodiumt0t4$sign== "*", 8, 4)
#dp_val_sodiumt0t4$size <- as.numeric(dp_val_sodiumt0t4$size)
dp_val_sodiumt0t4


plotdeltasodiumnew <- delta.sodium %>% ggplot(aes(x=factor(treatment, level= treat.order), y= delta, fill= treatment))+
  geom_point(pch= 23, size= 7)+
  xlab("")+
  ylab("sodium \u0394")+
  geom_hline(yintercept= 0, linetype = "dashed", color = "red")+
  scale_fill_manual(values= treat.colors)+
  geom_text(data = dp_val_sodiumt0t4, aes(x = treatment, y = Estimate, label = sign),
            position = position_dodge(width = 0.8), vjust = -0.5, size = 8)+
  guides(fill=guide_legend(title="Treatment"))+
  scale_x_discrete(labels= treat.labels)+
  theme_classic2()+
  stat_summary(fun=mean, aes(x= treatment, y = delta),geom= "crossbar", width=0.5, colour= "grey20", data=delta.sodium)+
  labs(title = "", subtitle = "", caption = "Different (*) indicates differences between the delta T4-T0 variation.\n Cross bar meaning the mean of delta.", size = 10)+
  ggtitle("sodium \u0394 variation T0 between T4", subtitle= paste("LinealModel-Anova Treatment(Tukey) p-value: ", format(newanova_deltasodiumt0t4$`Pr(>F)`[[1]], scientific= TRUE, digits=2 ), sep= ""))+
  theme(
    plot.title = element_text(size = 11),
    plot.subtitle = element_text(size = 10),
    plot.caption = element_text(size = 8))
...
plotdeltasodiumnew
ggsave(plotdeltasodiumnew, file="soil_parameters_result/plotdeltasodiumnew.png", width= 1900,height= 1200, units= "px")
...
########################delta new####################
delta.potassium
delta.potassium.lm0 <- lm(delta ~ 0+treatment, data=delta.potassium) #modelo normal 
delta.potassium.lm0

summary(delta.potassium.lm0) 
newanova_deltapotassiumt0t4 <-anova(delta.potassium.lm0)#3.973e-06 ***
newanova_deltapotassiumt0t4
dp_val_potassiumt0t4 <- summary(delta.potassium.lm0)$coefficient%>%
  as.data.frame()%>%
  rownames_to_column(var= "treatment")
dp_val_potassiumt0t4
dp_val_potassiumt0t4$treatment<-sub("treatment", "", dp_val_potassiumt0t4$treatment)#add sig. que no sean lettras
dp_val_potassiumt0t4$sign <- ifelse(dp_val_potassiumt0t4$`Pr(>|t|)`<0.05, "*", "ns")
dp_val_potassiumt0t4$sign <- ifelse(dp_val_potassiumt0t4$`Pr(>|t|)`>0.05, paste("ns"),
                                 ifelse(dp_val_potassiumt0t4$`Pr(>|t|)`>0.01, paste("*"),
                                        ifelse(dp_val_potassiumt0t4$`Pr(>|t|)`> 0.001,
                                               paste("**"), paste("***"))))#para add la

dp_val_potassiumt0t4
#dp_val_potassiumt0t4$size <- ifelse(dp_val_potassiumt0t4$sign== "*", 8, 4)
#dp_val_potassiumt0t4$size <- as.numeric(dp_val_potassiumt0t4$size)
dp_val_potassiumt0t4


plotdeltapotassiumnew <- delta.potassium %>% ggplot(aes(x=factor(treatment, level= treat.order), y= delta, fill= treatment))+
  geom_point(pch= 23, size= 7)+
  xlab("")+
  ylab("potassium \u0394")+
  geom_hline(yintercept= 0, linetype = "dashed", color = "red")+
  scale_fill_manual(values= treat.colors)+
  geom_text(data = dp_val_potassiumt0t4, aes(x = treatment, y = Estimate, label = sign),
            position = position_dodge(width = 0.8), vjust = -0.5, size = 8)+
  guides(fill=guide_legend(title="Treatment"))+
  scale_x_discrete(labels= treat.labels)+
  theme_classic2()+
  stat_summary(fun=mean, aes(x= treatment, y = delta),geom= "crossbar", width=0.5, colour= "grey20", data=delta.potassium)+
  labs(title = "", subtitle = "", caption = "Different (*) indicates differences between the delta T4-T0 variation.\n Cross bar meaning the mean of delta.", size = 10)+
  ggtitle("potassium \u0394 variation T0 between T4", subtitle= paste("LinealModel-Anova Treatment(Tukey) p-value: ", format(newanova_deltapotassiumt0t4$`Pr(>F)`[[1]], scientific= TRUE, digits=2 ), sep= ""))+
  theme(
    plot.title = element_text(size = 11),
    plot.subtitle = element_text(size = 10),
    plot.caption = element_text(size = 8))

plotdeltapotassiumnew
ggsave(plotdeltapotassiumnew, file="soil_parameters_result/plotdeltapotassiumnew.png", width= 1900,height= 1200, units= "px")
...
########################delta new####################
delta.nitrogen
delta.nitrogen.lm0 <- lm(delta ~ 0+treatment, data=delta.nitrogen) #modelo normal 
delta.nitrogen.lm0

summary(delta.nitrogen.lm0) 
newanova_deltanitrogent0t4 <-anova(delta.nitrogen.lm0)#3.973e-06 ***
newanova_deltanitrogent0t4
dp_val_nitrogent0t4 <- summary(delta.nitrogen.lm0)$coefficient%>%
  as.data.frame()%>%
  rownames_to_column(var= "treatment")
dp_val_nitrogent0t4
dp_val_nitrogent0t4$treatment<-sub("treatment", "", dp_val_nitrogent0t4$treatment)#add sig. que no sean lettras
dp_val_nitrogent0t4$sign <- ifelse(dp_val_nitrogent0t4$`Pr(>|t|)`<0.05, "*", "ns")
dp_val_nitrogent0t4$sign <- ifelse(dp_val_nitrogent0t4$`Pr(>|t|)`>0.05, paste("ns"),
                                 ifelse(dp_val_nitrogent0t4$`Pr(>|t|)`>0.01, paste("*"),
                                        ifelse(dp_val_nitrogent0t4$`Pr(>|t|)`> 0.001,
                                               paste("**"), paste("***"))))#para add la

dp_val_nitrogent0t4
#dp_val_nitrogent0t4$size <- ifelse(dp_val_nitrogent0t4$sign== "*", 8, 4)
#dp_val_nitrogent0t4$size <- as.numeric(dp_val_nitrogent0t4$size)
dp_val_nitrogent0t4


plotdeltanitrogennew <- delta.nitrogen %>% ggplot(aes(x=factor(treatment, level= treat.order), y= delta, fill= treatment))+
  geom_point(pch= 23, size= 7)+
  xlab("")+
  ylab("nitrogen \u0394")+
  geom_hline(yintercept= 0, linetype = "dashed", color = "red")+
  scale_fill_manual(values= treat.colors)+
  geom_text(data = dp_val_nitrogent0t4, aes(x = treatment, y = Estimate, label = sign),
            position = position_dodge(width = 0.8), vjust = -0.5, size = 8)+
  guides(fill=guide_legend(title="Treatment"))+
  scale_x_discrete(labels= treat.labels)+
  theme_classic2()+
  stat_summary(fun=mean, aes(x= treatment, y = delta),geom= "crossbar", width=0.5, colour= "grey20", data=delta.nitrogen)+
  labs(title = "", subtitle = "", caption = "Different (*) indicates differences between the delta T4-T0 variation.\n Cross bar meaning the mean of delta.", size = 10)+
  ggtitle("nitrogen \u0394 variation T0 between T4", subtitle= paste("LinealModel-Anova Treatment(Tukey) p-value: ", format(newanova_deltanitrogent0t4$`Pr(>F)`[[1]], scientific= TRUE, digits=2 ), sep= ""))+
  theme(
    plot.title = element_text(size = 11),
    plot.subtitle = element_text(size = 10),
    plot.caption = element_text(size = 8))

plotdeltanitrogennew
ggsave(plotdeltanitrogennew, file="soil_parameters_result/plotdeltanitrogennew.png", width= 1900,height= 1200, units= "px")
