...
ph.water.t0 <- data.frame( treatment=ph.water.t0$treatment, ph.waterrus.t0= ph.water.t0$ph.waterrus)
ph.water.t4 <- subset(soilt0t4, soilt0t4$time == "t4")
ph.water.t4 <- data.frame( treatment=ph.water.t4$treatment, ph.waterrus.t4= ph.water.t4$ph.waterrus)

delta.ph.water <- data.frame(treatment= ph.water.t0$treatment,t4= ph.water.t4$ph.waterrus.t4 ,t0= ph.water.t0$ph.waterrus.t0)
