...
banana.paleta = list(
  ...
  paleta.iro= c("royalblue1","chocolate4","green4","darkseagreen","darkolivegreen4","red3","darkorchid1"))
...
banana.paleta.f("paleta.iro", all_palettes = banana.paleta, type= "discrete")
...
cfu.data.plot %>% ggplot(aes(x= time, y= mean_cfu, group= treatment, col= treatment))+
  ...
  xlab("Time")+ ylab("CFU")+
  scale_colour_banana_disc("paleta.iro")+
